"""
Ejercicio 1: Trabajo con el programa de cifrado César con errores - Parte 1
"""
# Módulo Laboratorio: Programa de Cifrado César Error #1
#
...
def cifrarMensaje(mensaje, claveCifrado, alfabeto):
    ...
    claveCifrado = int(claveCifrado)  # Correccion del error: Convertir claveCifrado a entero
    for caracterActual in mensajeMayusculas:
        posicion = alfabeto.find(caracterActual)
        nuevaPosicion = posicion + claveCifrado
